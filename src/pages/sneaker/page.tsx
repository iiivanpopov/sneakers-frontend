...
export function SneakerPage() {
  ...
  return (
    <>
      <Helmet>
        <title>{sneaker.name} – Buy now at Ryst</title>
        <meta name="description" content={sneaker.description} />
        <meta property="og:title" content={`${sneaker.name} – Ryst`} />
        <meta property="og:description" content={sneaker.description} />
        <meta property="og:image" content={sneaker.images[0]} />
        <meta property="og:type" content="product" />
        <meta name="twitter:title" content={`${sneaker.name} – Ryst`} />
        <meta name="twitter:description" content={sneaker.description} />
        <meta name="twitter:image" content={sneaker.images[0]} />
      </Helmet>
